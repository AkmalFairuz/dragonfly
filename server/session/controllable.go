...
type Controllable interface {
	...
	UseItem()
	ReleaseItem()
	// PrepareCraft prepares a crafting plan for a recipe crafted directly from the crafting grid.
	PrepareCraft(recipe recipe.Recipe, times int) (crafting.Plan, error)
	// PrepareAutoCraft prepares a crafting plan for a recipe crafted from the crafting grid and inventory.
	PrepareAutoCraft(recipe recipe.Recipe, times int) (crafting.Plan, error)
	// PrepareDynamicCraft prepares a crafting plan for a server-side dynamic crafting recipe.
	PrepareDynamicCraft(times int) (crafting.Plan, error)
